...
const ERROR_TEXT: Record<string, string> = {
  ...
  ERR_DUPLICATE_INCIDENT: "This proposal action already has an open incident.",
  ...
  ERR_NOTHING_TO_CLAIM: "There is nothing to withdraw for this account, or it has no escrow position.",
  ERR_TRANSFER: "The transfer could not be queued. Try again.",
  ERR_PROPOSAL_NOT_FOUND: "The governor has no such proposal, or its ProposalCreated event is not in that block.",
  ERR_INVALID_ACTION_INDEX: "The proposal has fewer actions than that index.",
  ERR_PROPOSAL_MISMATCH: "The proposal's event and the governor's stored actions disagree.",
  ERR_PROPOSAL_NOT_ACTIONABLE: "Only pending, active, succeeded or queued proposals can be flagged; this one can no longer execute.",
  ERR_UNVERIFIED_DAO: "This DAO is unverified: its timelock admin is not its declared governor.",
  ERR_UNKNOWN_CHAIN: "No RPC endpoint is registered for that chain.",
  ERR_RPC_UNAVAILABLE: "The chain RPC did not answer. Try again shortly.",
  ERR_RPC: "The chain RPC returned an unusable answer.",
  ERR_INVALID_SELECTOR_PREIMAGE: "A signature does not hash to the selector it is registered under.",
  ERR_IMMUTABLE_SELECTOR: "Well-known privileged selectors cannot be remapped.",
  ERR_CLOSURE_NOTICE: "Withdrawing your escrow position needs your own 14-day closure notice first.",
  ERR_UNRESOLVED_INCIDENTS: "The escrow is pinned until this DAO's open incidents settle.",
